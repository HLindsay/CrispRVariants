...
that can be read in using the **rtracklayer** package.  The import() commmand
below returns a GRanges object.
...
```{r, fig.width = 8.5, fig.height = 7.5, message = FALSE, fig.cap = "(Top) schematic of gene structure showing guide location (left) consensus sequences for variants (right) variant counts in each embryo."}
...
```{r, fig.width = 8.5, fig.height = 7.5, message = FALSE}
